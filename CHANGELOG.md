...
- A Homebrew cask for the tap `sumdahl/homebrew-geet`
  (`brew install sumdahl/geet/geet`), also generated by GoReleaser and also
  not pushed yet (`homebrew_casks.skip_upload`), until the
